...
class BadgeController {
    ...
    static let sharedBadgeController = BadgeController()
    
    lazy var badges : [Badge] = {
        var _badges = [Badge]()
        var error : NSError?
        
        if let filePath = NSBundle.mainBundle().pathForResource("badges", ofType: "json") as String!{
            do{
    ...
    func badgeEarnStatusesForRuns(runs: [RunCoreDataModel]) -> [BadgeEarnStatus] {
...
class BadgeEarnStatus {
    let badge: Badge
    var earnRun: RunCoreDataModel?
    var silverRun: RunCoreDataModel?
    var goldRun: RunCoreDataModel?
    var bestRun: RunCoreDataModel?
